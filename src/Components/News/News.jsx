  ...
  return (
    <section className="news-section py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8 text-blue-400">News & Events</h2>
              ...
              <ul role="list" aria-labelledby="official-notifications-title">
                {limitedNotifications.map((notification) => (
                  <li key={notification._id} className="news-card flex bg-white border border-gray-300 hover:border-gray-400 transition duration-300 px-5 py-5 mb-4 rounded-lg">
                    ...
                    <p className="text-gray-600 text-base line-clamp-2 w-2/3">{notification.description}</p>
                  </li>
                ))}
              </ul>
              <div className="flex justify-center mt-4">
                <Link to="/notifications" className="text-blue-500 hover:text-blue-700 transition duration-300 py-2 px-4 rounded-md">
                  Read More
                </Link>
              </div>
            </div>
              ...
              <ul role="list" aria-labelledby="latest-events-title">
                {limitedEvents.map((event) => (
                  <li key={event._id} className="news-card flex bg-white border border-gray-300 hover:border-gray-400 transition duration-300 px-5 py-5 mb-4 rounded-lg">
                    ...
                    <p className="text-gray-600 text-base line-clamp-2 w-2/3">{event.description}</p>
                  </li>
                ))}
              </ul>
              <div className="flex justify-center mt-4">
                <Link to="/events" className="text-blue-500 hover:text-blue-700 transition duration-300 py-2 px-4 rounded-md">
                  Read More
                </Link>
              </div>
            </div>
