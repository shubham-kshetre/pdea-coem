...
import { Year2022 } from '../../data/gallery';
...
const Gallery2223 = () => {
  ...
  const selectedImages = Year2022[selectedCategory] || []; // Get images for selected category
  ...
  return (
    <div className="gallery-container bg-gray-100 min-h-screen p-8">
      ...
      >
        {Object.keys(Year2022).map((category) => (
          <GalleryCategory
            key={category}
            name={category}
