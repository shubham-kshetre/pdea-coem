...
import { iqacCommitteeData } from '../data/naac';

function IQACCommitte() {
    ...
    >
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-5 justify-between items-center mb-4">
          <h2 className="text-2xl font-bold">IQAC COMMITTEE</h2>
        </div>
