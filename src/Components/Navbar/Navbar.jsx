...
function Navbar() {
  ...
  return (
    <header className={`fixed w-full z-50 ${scrolled ? "bg-blue-900" : "bg-blue-800"} transition-colors duration-300`}>
      <div className="flex items-center justify-between p-4 w-full px-10">
        ...
        {/* Content Column */}
        <div className="flex flex-col flex-grow gap-4 mr-10">
          {/* First Row: Span and Buttons */}
          <div className="hidden md:flex items-center justify-between">
            <span className="text-white font-bold text-lg flex-grow text-end mr-32">
