    ...
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <div className="bg-gray-800 w-16 md:w-64 min-h-screen text-white shadow-lg hidden md:block">
        ...
        <div className="flex items-center justify-center mt-4 mb-6">
          ...
          <span className="hidden md:block text-xl font-bold ml-2">Pdea Coem</span>
        </div>
        ...
        <ul className="py-4">
          <li className="px-6 py-3">
            <Link
              ...
              className={`flex items-center ${
                selectedNavItem === 'admin-options' ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700'
              } px-2 py-1 rounded`}
            >
          ...
          <li className="px-6 py-3">
            <Link
              ...
              className={`flex items-center ${
                selectedNavItem === 'settings' ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700'
              } px-2 py-1 rounded`}
            >
        ...
        <ul className="flex justify-around py-2">
          <li>
            <Link
              ...
              className={`flex flex-col items-center py-2 ${
                selectedNavItem === 'admin-options' ? 'text-white' : 'text-gray-300 hover:text-white'
              }`}
            >
              <FiUsers />
          ...
          <li>
            <Link
              ...
              onClick={() => handleNavItemClick('settings')}
              className={`flex flex-col items-center py-2 ${
                selectedNavItem === 'settings' ? 'text-white' : 'text-gray-300 hover:text-white'
              }`}
            >
              <FiSettings />
