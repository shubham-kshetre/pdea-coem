...
const Notifications = () => {
  ...
  // Filtered notifications based on the search input
  ...
  return (
    ...
    <div className="bg-white min-h-screen py-24">
      <div className="container mx-auto px-4">
        ...
        <Filter filter={filter} setFilter={setFilter} /> {/* Pass filter state to Filter component */}
        <div className="grid grid-cols-1 gap-6 mt-6">
          {currentNotifications.map((notification) => (
            ...
            >
              ...
              <p className="text-gray-500 text-sm mt-2">{new Date(notification.date).toLocaleDateString()}</p>
            </motion.div>
          ))}
        </div>
